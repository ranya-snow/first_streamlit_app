...
data = {
    ...
    '3': [0.04, 0.0894, 0.2, 0.2991, 0.4472],
    '4': [0.09, 0.1643, 0.3, 0.4054, 0.5477],
    '5': [0.16, 0.253, 0.4, 0.503, 0.6325],
    '6': [0.25, 0.3536, 0.5, 0.5946, 0.7071],
    '7': [0.36, 0.4648, 0.6, 0.6817, 0.7746],
    '8': [0.49, 0.5857, 0.7, 0.7653, 0.8367],
    '9': [0.64, 0.7155, 0.8, 0.8459, 0.8944],
    '10': [0.81, 0.8538, 0.9, 0.924, 0.9487],
